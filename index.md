...
[mastodon](https://{{ site.mastodon_server | cgi_escape | escape }}/@{{ site.mastodon_username | cgi_escape | escape }} "@{{ site.mastodon_username | escape }} on {{ site.mastodon_server | escape }}"){:target="_blank"}{:rel="me"}, [LinkedIn](https://www.linkedin.com/in/{{ site.linkedin_username | escape }} "Milan Höllner on LinkedIn"){:target="_blank"}, 
